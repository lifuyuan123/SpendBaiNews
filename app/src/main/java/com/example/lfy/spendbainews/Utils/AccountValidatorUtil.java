...
public class AccountValidatorUtil {
     ...
     * 正则表达式：验证登陆密码
     */
    public static final String REGEX_LOGIN_PW = "^(?![0-9]+$)(?![a-zA-Z]+$)[a-zA-Z0-9]{6,12}$";
     ...
     * @return 校验通过返回true，否则返回false
     */
    public static boolean isLoginPw(String password) {
        return Pattern.matches(REGEX_LOGIN_PW, password);
    }
